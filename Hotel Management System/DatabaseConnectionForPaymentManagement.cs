    ...
    class DatabaseConnectionForPaymentManagement
    {
        ...
        internal bool UpdateCustormerPaymentStatus(string BillNo,string AdvancePaymentStatus,string FinalPaymentStatus,string CompetePaymentStatus)
        {
            ...
            try
            {
                ...
                SqlCeCommand UpdateCustormerBillDetails = new SqlCeCommand("update billDetails set advance_amt_sts = '" + AdvancePaymentStatus + "',final_amt_sts = '" + FinalPaymentStatus + "',complete_sts = '" + CompetePaymentStatus + "' where record_no = '" + BillNo + "'", conn);
