...
namespace Hotel_Management_System
{
    public partial class custormer_details : UserControl
    {
        ...
        private void MakeReservation_btn_Click(object sender, EventArgs e)
        {
            ...
            if (GettingPersonalInfoAndReservationInfo() == true && GetingLocationDetailsForReservation() == true && GetingFirstDayMealDetailsForReservation() == true && GetingSecondDayMealDetailsForReservation() == true && GetingThirdDayMealDetailsForReservation() == true && GettingTravelingInfoForReservation() == true && MakeBillForReservationDetails() == true)
            {
                GetDatabaseTableRecordCount();
        ...
        {
            if (UpdateCustormerPersonalInfoAndReservationInfo() == true && UpdateCustormerLocationDetails() == true && UpdateEventNamesAndDecorationTypes() == true && UpdateCustormerFirstDayMealDetails() == true && UpdateCustormerSecondDayMealDetails() == true && UpdateCustormerThirdMealDetails() == true && UpdateCustormerTravellingAndVehicleDetails() == true && UpdateCustormerBillDetails() == true)
            {
